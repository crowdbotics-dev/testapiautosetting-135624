...
class Testconnectors135624ViewSet(BaseConnectorViewSet):
    PASSWORD = settings.CONNECTOR_TESTCONNECTORS135624_PASSWORD
    USERNAME = settings.CONNECTOR_TESTCONNECTORS135624_USERNAME
    BASE_URL = "https://devstringx.com"
    AUTH_TYPE = "basic"
    IDENTIFIER = "CONNECTOR_TESTCONNECTORS135624"
